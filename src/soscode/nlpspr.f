...
c
C     A MATLAB interrupt or abandoned reverse-communication sequence can
C     bypass the normal termination cleanup.  Clear any saved work arrays
C     before constructing storage for a new run.
