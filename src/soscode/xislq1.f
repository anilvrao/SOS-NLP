...
c
c         sort integers into ascending order
c
c     input:
...
c
c     output:
c         key  -- will be arranged so that values are in ascending
c                 order
...
c             keys until all keys less than  v  are packed to the
c             left, all keys larger than  v  are packed to the right.
c         -----------------------------------------------------------
...
c             ---------------------------------------
 ...
 1100     continue
          if  (min (llen, rlen) .gt. tiny)  go to 1400
