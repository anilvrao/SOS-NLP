      ...
      SUBROUTINE CLKMAX(NCLOCK)
C
C ======================================================================
C     CLKMAX===>clkmax   J.T. BETTS
C ======================================================================
C
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C
C       PURPOSE:  ACCUMULATE THE MAXIMUM VALUE FOR CLOCK NUMBER NCLOCK
...
C
      IF(IERCLK(NCLOCK).EQ.+1) THEN
        ...
        INTOLD(NCLOCK) = INTOLD(NCLOCK) + 1
C
        IF(DELCLK.GT.CLKVAL(NCLOCK)) THEN
          CLKVAL(NCLOCK) = DELCLK
          INTCLK(NCLOCK) = INTOLD(NCLOCK)
        ENDIF
      ELSE
