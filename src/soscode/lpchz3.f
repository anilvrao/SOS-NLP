...
c     ==================================================================
c     ==================================================================
c     ====  lpchz3 / LPCHZ3 -- choose a constraint to add ...       ====
c     ====                     general case (infeasible point)      ====
c     ====                     Pass Two of Two                      ====
c     ====                     (special version of Pass Two)        ====
c     ==================================================================
c     ==================================================================
...
c
c     LPCHZ3 / lpchz3  finds a step alfa such that the point
...
c     which  firstv/mnsmvl is true.  This corresponds in QPOPT
c     to the first phase search for a infeasible point that
c     minimizes the sum of infeasibilities, undertaken only
c     after it has been determined that no feasible point exists.
c     
c     Input parameters
c     ----------------
...
c        --------------------------
c        ... test for smaller alfai
c        --------------------------

         if  ( talfai .le. alfai )  then
            alfai  = talfai
            jhiti  = j
         end if
