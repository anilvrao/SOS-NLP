      ...
      REAL FUNCTION hsmcon( i )
      
      IMPLICIT  none
      INTEGER   i, onei, bigi
      REAL      mcon, small, big, temp, e, pi, eulers, one
      PARAMETER ( 
     &  onei   = 1  ,  
     &  one    = 1.0E0,  
     &  e      = 2.71828182845904523536028747135266249775724709E+0,  
     &  pi     = 3.14159265358979323846264338327950288419716940E+0,  
     &  eulers = 5.77215664901532860606512090082402431042159336E-1 )
